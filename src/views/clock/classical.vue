<template>
  <div class="dragable box-border flex justify-between w-full max-w-full h-[50vw] border border-soild border-gray-500 rounded-full bg-violet-100">
    <div class="flex-1 w-[50vw] h-[50vw] py-[5vw] px-[8vw] ">
